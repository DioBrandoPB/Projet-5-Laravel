...
<section id="profile">
    <div class="bloc">
        ...
        <div class="bloc-aligner"> <button class="boutons btnBasique"><span>Changer mon MDP</span></button>
            <button class="boutons btnBasique"><span><a href="/deconnexion"> Déconnexion</span></a></button></div>
